...
public class ZqlJJParser implements ZqlJJParserConstants {
	...
	public static void main(String args[]) throws ParseException {
		...
		if (args.length < 1) {
			...
			try {
				p = new ZqlJJParser(new DataInputStream(new FileInputStream(args[0])));
		 ...
		 * 
		 * for(int i=0; i<v.size(); i++) { ZStatement st =
		 * (ZStatement)v.elementAt(i); System.out.println(st.toString()); }
		 */
	...
	static final public ZExp SQLPrimaryExpression() throws ParseException {
		...
		default:
			...
			if (jj_2_12(2147483647)) {
				...
				{
					if (true)
						return new ZExpression("COUNT", new ZConstant("*", ZConstant.COLUMNNAME));
				}
			} else if (jj_2_14(3)) {
				s = AggregateFunc();
				jj_consume_token(88);
	...
	static final public ZExpression FunctionCall() throws ParseException {
		...
		jj_consume_token(90);
		FunctionDesc funDesc = ZUtils.getCustomFunction(s);
		if (funDesc == null) {
			if (!ZUtils.isAggregate(s)) {
				throw new ParseException("Undefined function: " + s);
			}
		} else {
			if (funDesc.getParamCount() != parm.size() && !funDesc.isHasMoreParams()) {
				throw new ParseException("Function " + s + " should have " + funDesc.getParamCount()
						+ " parameter(s)");
			}
			if (funDesc.getParamCount() > parm.size() && funDesc.isHasMoreParams()) {
				throw new ParseException("Function " + s + " should have at least " + funDesc.getParamCount()
						+ " parameter(s)");
			}
		}
		e = new ZExpression(s);
	...
	private static void jj_la1_init_0() {
		jj_la1_0 = new int[] { 0x8008000, 0x0, 0x0, 0x810b000, 0x4220000, 0x4000000, 0x4220000, 0x0, 0x10000,
				0x0, 0x0, 0x0, 0x10000, 0x0, 0x1000000, 0x0, 0x0, 0x1000000, 0x0, 0x0, 0x0, 0x2080400, 0x0,
				0x0, 0x0, 0x20000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x10000000, 0x800020,
				0x800020, 0x0, 0x40000, 0x40000000, 0x0, 0x0, 0x80400, 0x100, 0x80400, 0x100, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x80000000, 0x20, 0x0, 0x0, 0x400200, 0x400200, 0x0, 0x400200, 0x400200, 0x0,
				0x0, 0x0, 0x40, 0x0, 0x80400, 0x0, 0x0, 0x80400, 0x0, 0x0, 0x800, 0x0, 0xa0, 0xa0, 0x0,
				0x80400, 0x80400, 0x0, 0x80400, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x800020,
				0x0, 0x0, 0x80400, 0x80400, 0x80400, 0x0, 0x0, };
	}

	private static void jj_la1_init_1() {
		jj_la1_1 = new int[] { 0x1011004, 0x0, 0x0, 0x1011004, 0x1a400082, 0x400000, 0x1a400082, 0x0, 0x0,
				0x0, 0x4000, 0x0, 0x0, 0x40000, 0x20000000, 0x4000000, 0x4000000, 0x24000000, 0x0, 0x0, 0x0,
				0x20a300, 0x0, 0x0, 0x8000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x100000,
				0x0, 0x0, 0x0, 0x0, 0x80000000, 0x0, 0x408, 0x0, 0x8300, 0x0, 0x8300, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x80000000, 0x80000000, 0x0, 0x0, 0x408, 0x8000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x20000, 0x80000, 0x0, 0x2000, 0x20a300, 0x2000, 0x200000, 0x208300, 0x0, 0x20, 0x2061, 0x0,
				0x0, 0x0, 0x200000, 0x208300, 0x8300, 0x2000, 0x8008300, 0x2000, 0x2000, 0x2000, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x8000, 0x0, 0x300, 0x300, 0x8300, 0x0, 0x0, };
	}

	private static void jj_la1_init_2() {
		jj_la1_2 = new int[] { 0xc0, 0x2000000, 0x1000000, 0xc0, 0x10, 0x0, 0x10, 0x400, 0x0, 0x2000000, 0x0,
				0x400, 0x0, 0x800, 0x0, 0x10, 0x10, 0x0, 0x40000, 0x100, 0x2000000, 0x1e41001, 0x2000000,
				0x1000000, 0x20, 0x0, 0x100, 0x20000000, 0x20000000, 0x840000, 0xd0000000, 0x20000000, 0x0,
				0x0, 0x41000, 0x0, 0x0, 0x0, 0x0, 0x100, 0x0, 0x0, 0x8, 0x2000000, 0x1e41001, 0x840000,
				0x1e41001, 0x0, 0x40000, 0x840000, 0x2000000, 0x40000, 0x0, 0x0, 0x0, 0x0, 0x8, 0x0, 0x0,
				0x0, 0x2000000, 0x0, 0x0, 0x2000000, 0x0, 0x0, 0x0, 0x0, 0x1e41001, 0x0, 0x0, 0x1e41001,
				0xd0000000, 0x0, 0xd0000000, 0x2000000, 0x0, 0x0, 0x0, 0x1e41001, 0x1e41001, 0x0, 0x1e41001,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1e41000, 0x1, 0x40001,
				0x1e41001, 0x20000000, 0x20000000, };
	}

	private static void jj_la1_init_3() {
		jj_la1_3 = new int[] { 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x260, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1f, 0x0, 0x60,
				0x60, 0x60, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xe0, 0x0, 0x60, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x60,
				0x0, 0x0, 0x60, 0x1f, 0x0, 0x1f, 0x0, 0x0, 0x0, 0x0, 0x260, 0x260, 0x0, 0x260, 0x0, 0x0, 0x0,
				0x460, 0x460, 0x880, 0x880, 0x1000, 0x60, 0x60, 0x0, 0x0, 0x0, 0x0, 0x0, 0x260, 0x0, 0x0, };
	}
